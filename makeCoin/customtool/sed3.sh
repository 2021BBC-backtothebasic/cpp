...
echo $(cd ${pjname}coin; git clone https://github.com/eumcloud/makepractice ./sampleparams; mv ./sampleparams/chainparams.cpp ./src/chainparams.cpp; mv ./sampleparams/chainparamsseeds.h ./src/chainparamsseeds.h/; rm -r ./sampleparams/ ;
 )
}
testformake
